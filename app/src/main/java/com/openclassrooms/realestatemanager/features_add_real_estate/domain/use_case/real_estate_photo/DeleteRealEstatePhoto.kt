package com.openclassrooms.realestatemanager.features_add_real_estate.domain.use_case.real_estate_photo
...
class DeleteRealEstatePhoto(
private val repository: RealEstatePhotoRepository
) {

    suspend operator fun invoke(id: Long) = repository.deleteRealEstatePhoto(id)
